...
// これまでのサンプルでは一貫してボックスばかり使っていましたが、
// 代表的なその他のジオメトリについてもここで試してみましょう。
// 引数がそれぞれどういった意味を持っているのか疑問に思ったときは、
// 公式のドキュメント等を参考にしましょう。
// three.js docs - https://threejs.org/docs/index.html
//
// ちなみに、ここでは「マテリアルについては同じものを使いまわしている」という点も地味に重要です。
// 個別に色や質感を変えたい場合は、もちろん別々のマテリアルを使っても問題はありませんが、
// 同じ質感であればマテリアルは再利用することで無駄なくプログラムを組むことができますし、メモリなども節約できます。
