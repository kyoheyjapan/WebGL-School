// = 006 ======================================================================
// MeshLambertMaterial と DirectionalLight の組み合わせは、
// 光の表現方法としては拡散光と呼ばれます。
// 拡散光は文字通り、物体に光が当たって拡散する様子を意味した言葉です。
// MeshLambertMaterial はこの拡散光を表現できるマテリアルですが、
// three.js にはその他にもいくつかマテリアルが用意されています。
// ここでは MeshPhongMaterial を利用して「反射光」と「環境光」を表現してみましょう。
// ============================================================================
